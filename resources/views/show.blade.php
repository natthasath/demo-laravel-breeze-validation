            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form class="max-w-sm mx-auto" method="post" action="/form">
                        ...
                        <div class="mb-5">
                            <label for="privilege" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Privilege</label>
                            <div class="flex">
                                <div class="flex items-center me-4">
                                    <input type="checkbox" id="checkbox1" name="checkbox1" value="User" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="checkbox1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">User</label>
                                </div>
                                <div class="flex items-center me-4">
                                    <input type="checkbox" id="checkbox2" name="checkbox2" value="Administrator" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="checkbox2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Administrator</label>
                                </div>
                            </div>
                        </div>
